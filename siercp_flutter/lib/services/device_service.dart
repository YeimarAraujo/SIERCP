  ...
  factory DeviceInfo.fromMap(String mac, Map<dynamic, dynamic> data) {
    ...
    if (isNewFormat) {
      return DeviceInfo(
        ...
        compresionesCorrectas:
            (data['compresiones_correctas'] as num?)?.toInt() ?? 0,
        ...
        avgProfundidadMm:
            (data['avg_profundidad_mm'] as num?)?.toDouble() ?? 0.0,
...
class DeviceStatus {
  ...
  factory DeviceStatus.disconnected() => const DeviceStatus(isConnected: false);
}
