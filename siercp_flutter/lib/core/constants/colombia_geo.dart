...
const Map<String, List<String>> colombiaGeo = {
  'Amazonas': [
  ...
  'Antioquia': [
    ...
    'Andes', 'Angelópolis', 'Angostura', 'Anorí', 'Anza', 'Apartadó',
    'Arboletes', 'Argelia', 'Armenia', 'Barbosa', 'Bello', 'Betania',
    ...
    'Mutatá', 'Nariño', 'Nechí', 'Necoclí', 'Olaya', 'Peque', 'Pueblorrico',
  ...
  'Bolívar': [
    ...
    'Mompós', 'Montecristo', 'Morales', 'Norosí', 'Pinillos', 'Regidor',
  ...
  'Boyacá': [
    ...
    'Chíquiza', 'Chivor', 'Ciénega', 'Cómbita', 'Coper', 'Corrales',
    'Covarachía', 'Cubará', 'Cucaita', 'Cuítiva', 'Chiscas', 'El Cocuy',
    'El Espino', 'Firavitoba', 'Floresta', 'Gachantivá', 'Gámeza', 'Garagoa',
    'Guacamayas', 'Guateque', 'Guayatá', 'Güicán', 'Iza', 'Jenesano',
    'Jericó', 'La Capilla', 'La Uvita', 'La Victoria', 'Labranzagrande',
    'Macanal', 'Maripí', 'Miraflores', 'Mongua', 'Monguí', 'Moniquirá',
    'Motavita', 'Muzo', 'Nobsa', 'Nuevo Colón', 'Oicatá', 'Otanche',
    'Pachavita', 'Páez', 'Paipa', 'Pajarito', 'Panqueba', 'Pauna', 'Paya',
  ...
  'Casanare': [
    'Yopal', 'Aguazul', 'Chameza', 'Hato Corozal', 'La Salina', 'Maní',
  ...
  'Cauca': [
    ...
    'Silvia', 'Sotara', 'Sucre', 'Suárez', 'Timbío', 'Timbiquí', 'Toribío',
    'Totoró', 'Villa Rica',
  ],
  'Cesar': [
  ...
  'Chocó': [
    ...
    'Nuquí', 'Río Iro', 'Río Quito', 'Riosucio', 'San José del Palmar',
  ...
  'Córdoba': [
    ...
    'Sahagún', 'San Andrés de Sotoavento', 'San Antero', 'San Bernardo del Viento',
    'San Carlos', 'San José de Uré', 'San Pelayo', 'Tierralta', 'Tuchín',
    'Valencia',
  ],
  'Cundinamarca': [
    'Bogotá', 'Agua de Dios', 'Albán', 'Anapoima', 'Anolaima', 'Apulo',
    ...
    'La Mesa', 'La Palma', 'La Peña', 'La Vega', 'Lenguazaque', 'Macheta',
    'Madrid', 'Manta', 'Medina', 'Mosquera', 'Nariño', 'Nemocón',
    'Nilo', 'Nimaima', 'Nocaima', 'Venecia', 'Pacho', 'Paime', 'Pandi',
    ...
    'Tabio', 'Tausa', 'Tena', 'Tibacuy', 'Tibiritá', 'Tocaima', 'Tocancipá',
    'Topaipí', 'Ubalá', 'Ubaque', 'Une', 'Utica', 'Vergara', 'Vianí',
    'Villa de San Diego de Ubaté', 'Villeta', 'Viotá', 'Yacopí', 'Zipacón',
    'Zipaquirá',
  ],
  'Guainía': [
  ...
  'Meta': [
    ...
    'Lejanías', 'Mapiripán', 'Mesetas', 'Playa Rica', 'Puerto Concordia',
  ...
  'Nariño': [
    ...
    'Ospina', 'Policarpa', 'Potosí', 'Providencia', 'Puerres', 'Pupiales',
  ...
  'Santander': [
    ...
    'El Playón', 'Encino', 'Enciso', 'Florián', 'Floridablanca', 'Gámbita',
  ...
  'Sucre': [
    'Sincelejo', 'Buenavista', 'Caimito', 'Chalán', 'Coloso', 'Corozal',
  ...
  'Tolima': [
    ...
    'Rovira', 'Saldaña', 'San Antonio', 'San Luis', 'Santa Isabel',
  ...
  'Valle del Cauca': [
    ...
    'Palmira', 'Pradera', 'Restrepo', 'Riofrío', 'Roldanillo', 'San Pedro',
...
final List<String> colombiaDepartments = colombiaGeo.keys.toList()..sort();

/// Obtiene los municipios ordenados correspondientes a un departamento.
List<String> getMunicipalities(String department) {
  final list = colombiaGeo[department] ?? [];
