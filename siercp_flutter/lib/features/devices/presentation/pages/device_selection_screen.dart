...
class _DeviceSelectionScreenState extends ConsumerState<DeviceSelectionScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Maniquí conectado exitosamente'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Escáner Bluetooth'),
        centerTitle: true,
        actions: [
          IconButton(
            icon: _isScanning
          ...
          ? const Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  Text("Estableciendo conexión BLE de baja latencia...",
                      style: TextStyle(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Buscando maniquíes cercanos. Asegúrate de que el simulador de RCP esté encendido y cerca de tu dispositivo.',
                  ...
                  child: StreamBuilder<List<ScanResult>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasError) {
                        return Center(
                            child: Text('Error de escaneo: ${snapshot.error}',
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Text(
                                  '${device.remoteId.str} • RSSI: ${r.rssi} dBm',
