...
extension GuideCategoryExtension on GuideCategory {
  ...
  static GuideCategory fromValue(String? val) {
    switch (val) {
      case 'tecnica':
        return GuideCategory.tecnica;
      case 'teoria':
        return GuideCategory.teoria;
      case 'seguridad':
        return GuideCategory.seguridad;
      case 'emergencias':
        return GuideCategory.emergencias;
      case 'equipamiento':
        return GuideCategory.equipamiento;
      default:
        return GuideCategory.tecnica;
    }
  }
...
class GuideProgress {
  ...
  factory GuideProgress.fromMap(
      Map<String, dynamic> d, String guideId, String userId) {
...
class GuideProgressSummary {
  ...
  double get completionPct =>
      totalGuides == 0 ? 0 : completedGuides / totalGuides;
  double get requiredPct =>
      requiredGuides == 0 ? 0 : requiredCompleted / requiredGuides;
  bool get allRequiredDone =>
      requiredGuides > 0 && requiredCompleted >= requiredGuides;
}

List<Map<String, dynamic>> preloadedGuides(
    ...
    [
      {
        ...
        'description':
            'Aprende la posición correcta, profundidad y frecuencia según AHA 2020',
        'courseId': courseId,
        'pdfUrl': '',
      ...
      },
      {
        ...
        'description':
            'Los 5 eslabones críticos para salvar vidas en una emergencia cardíaca',
        'courseId': courseId,
        'pdfUrl': '',
        'uploadedBy': instructorId,
        'uploaderName': instructorName,
      ...
      },
      {
        ...
        'title': 'Uso del DEA',
        'description':
            'Paso a paso para usar un desfibrilador externo automático correctamente',
        'courseId': courseId,
        'pdfUrl': '',
        'uploadedBy': instructorId,
        'uploaderName': instructorName,
      ...
      },
      {
        ...
        'description':
            'Protégete mientras salvas vidas: guantes, barreras y precauciones',
        'courseId': courseId,
        'pdfUrl': '',
        'uploadedBy': instructorId,
        'uploaderName': instructorName,
      ...
      },
      {
        ...
        'description':
            'Diferencias críticas al reanimar víctimas de ahogamiento en agua',
        'courseId': courseId,
        'pdfUrl': '',
        'uploadedBy': instructorId,
        'uploaderName': instructorName,
