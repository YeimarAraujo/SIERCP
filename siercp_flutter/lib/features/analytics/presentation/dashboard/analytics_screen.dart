...
import 'package:siercp/features/analytics/data/models/analytics_models.dart';
import 'package:siercp/features/analytics/presentation/providers/analytics_providers.dart';
import 'package:siercp/features/analytics/presentation/widgets/analytics_widgets.dart';
  ...
  Widget _buildScatterChart(List<Map<String, double>> points) {
    ...
    List<ScatterSpot> scatterSpots = points.map((p) {
      return ScatterSpot(
        ...
        dotPainter: FlDotCirclePainter(color: AppColors.cyan.withValues(alpha: 0.6), radius: 4),
      );
    }).toList();
